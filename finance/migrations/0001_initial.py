# Generated by Django 4.2.2 on 2023-08-03 13:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(related_name='expenses_set', to='finance.category')),
            ],
        ),
        migrations.CreateModel(
            name='Income',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('categories', models.ManyToManyField(related_name='incomes_set', to='finance.category')),
            ],
        ),
        migrations.CreateModel(
            name='MonthlyPeriod',
