...
urlpatterns = [
    ...
    path('monthly-period/<int:id>/delete-income', income.delete_income, name="delete_income"),
    path('monthly-period/<int:id>/save-expense', expense.create_expense, name="create_expense"),
    path('monthly-period/<int:id>/delete-expense', expense.delete_expense, name="delete_expense"),
